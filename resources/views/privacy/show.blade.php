    ...
    <x-container>
        ...
        <div class="flex">
            <div class="mt-6 pl-3 pr-12 w-2/3 border-r border-zinc-500">                
                <div class="flex mb-7">
                    <h3 class="pl-1.5 pr-4 pb-3 border-b border-sky-500 uppercase text-lg">Privacy policy</h3>
                ...
                <div class="flex">
                    <div class=" w-1/2">
                        ...
                        <p>
                            ...
                            Matchbird GmbH, Zimmerstraße 19, 40215 Düsseldorf
                        </p>

                        <p>
                            <b>Kontakt</b><br>
                            Telefon: +49 211 936716-0<br>
                            E-Mail: <a href="info@matchbird.com" target="_blank">info@matchbird.com</a>
                        </p>
                    </div>
                ...
                <p>Der Datenerhebung und -speicherung kann widersprochen werden. Diese Website verwendet Google Analytics mit der Erweiterung "_anonymizeIp()", IP-Adressen werden daher nur gekürzt weiterverarbeitet, um eine direkte Personenbeziehbarkeit auszuschließen.</p>
