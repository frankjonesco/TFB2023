                ...
                @endif
                    ...
                    <td class="p-2.5 m-0 !text-xs">
                        <div class="flex items-center">
                            ...
                            >
                            <a href="{{$company->link()}}" class="plain whitespace-nowrap hover:!underline">{{$company->show_name}}</a>
                        </div>
                    </td>
                    <td class="p-2.5 m-0 text-right whitespace-nowrap !text-xs">
                        {{formatTurnover($company->ranking->turnover)}}
                    </td>
                    <td class="p-2.5 text-right whitespace-nowrap !text-xs">
                        <x-ranking-growth growth="{{$company->latest_ranking->calculateGrowth('turnover')}}" />
                    </td>
                </tr>
            @endforeach
        </tbody>
