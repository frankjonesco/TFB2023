<nav class="bg-[#292c2c] border-gray-200 dark:bg-[#292c47] dark:border-gray-700 {{request()->segment(1) == 'dashboard' ? 'mb-0' : 'mb-10'}}">
    <div class="px-6 flex flex-wrap items-center justify-between mx-auto">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
            <ul class="flex flex-col py-12 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-indigo-900 md:dark:bg-[#292c47] dark:border-gray-700">
                <li>
                    <a href="/" class="bg-transparent block py-2 pl-3 pr-4 rounded md:p-0 {{request()->segment(1) == null ? 'text-white dark:text-white' : 'text-gray-400 dark:text-gray-400'}}" aria-current="page">Home</a>
                </li>
                <li>
