<div class="mt-8 flex border-t border-gray-200 border-b">
    <div class="w-1/2 border-r border-gray-200">
        <div class="flex items-center px-8 py-8">
            <a href="/news/articles/{{$articles[0]->hex}}/{{$articles[0]->slug}}">
            ...
            <div class="post-content overflow-hidden">
                <div class="text-sm p-0 mb-2">
                    <h4 class="text-gray-500 text-xs font-bold">
                        <a href="/news/articles/{{$articles[0]->hex}}/{{$articles[0]->slug}}" class="text-slate-900 hover:!text-red-500">
                            {{$articles[0]->title}}
                        </a>
                    </h4>
                </div>
    ...
    <div class="w-1/2">
        <div class="flex flex-row-reverse items-center px-8 py-8 w-full">
            <a href="/news/articles/{{$articles[1]->hex}}/{{$articles[1]->slug}}">
            ...
            <div class="post-content overflow-hidden text-left w-full">
                <div class="text-sm p-0 mb-2">
                    <h4 class="text-gray-500 text-xs font-bold">
                        <a href="/news/articles/{{$articles[1]->hex}}/{{$articles[1]->slug}}" class="text-slate-900 hover:!text-red-500">
                            {{$articles[1]->title}}
                        </a>
                    </h4>
                </div>
