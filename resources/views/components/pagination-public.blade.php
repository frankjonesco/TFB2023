        ...
        <div class="flex items-center mb-5">
            ...
            <div>
                <ul class="inline-flex items-center -space-x-px text-xs">
                            ...
                            <li>
                                <a href="{{$results->url($i)}}"
                                    @if($results->currentPage() == $i)
                                        class="px-3 py-2 mr-1.5 leading-tight text-gray-500 bg-red-500 text-white hover:bg-red-600 hover:!text-white"
                                    @else
                                        class="px-3 py-2 mr-1.5 leading-tight text-gray-500 bg-white text-gray-500 border border-gray-200 hover:bg-red-500 hover:!text-white"
                                    @endif
                    ...
                    <li>
                        <a href="{{$results->nextPageUrl()}}" class="px-3 py-2 mr-1.5 leading-tight text-gray-500 bg-white text-gray-500 border border-gray-200 hover:bg-red-500 hover:!text-white">
                            Next
                        </a>
                    </li>
